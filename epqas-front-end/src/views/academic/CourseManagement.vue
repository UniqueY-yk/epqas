<template>
  <div class="course-management examination-paper-management">
    <div class="page-header">
      <h2>课程管理</h2>
      <p class="subtitle">管理系统中的所有课程信息及其代码</p>
    </div>

    <el-card class="toolbar-card" shadow="hover">
      <div class="toolbar">
        <div class="search-area">
          <el-input v-model="searchForm.courseName" placeholder="按课程名称搜索..." clearable class="search-input" @keyup.enter="fetchData" >
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="600px" class="paper-dialog" destroy-on-close>
      <el-form :model="form" label-width="100px" :rules="rules" ref="courseFormRef" class="paper-form">
