...
/**
 * 综合分析数据查询Mapper，供班级分析和学生分析共用
 */
@Mapper
public interface AnalysisDataMapper {

    /**
     * 根据题目ID列表查询题目详情，可选按题目类型过滤
     * 
    ...
    @Select("<script>" +
            ...
            "</if>" +
            "</script>")
    List<Map<String, Object>> selectQuestionDetailsByIds(@Param("questionIds") List<Long> questionIds, @Param("questionType") String questionType);
